      ...
      <div className="h-150 w-200 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 place-self-center-safe bg-[#2c2f36] text-white rounded-xl shadow-lg max-w-2xl p-6">
        ...
        <div className="flex space-x-8">
          ...
          <div className="flex p-4 flex-col space-y-4 w-1/3">
            <button className="text-left hover:text-gray-300">General</button>
            <button className="text-left hover:text-gray-300">
              Data controls
            </button>
            <button className="text-left hover:text-gray-300">Main Language</button>
          </div>
            ...
            <div>
              ...
              <div className="relative inline-block w-48">
                <button
                  ...
                  className="w-full bg-gray-700 hover:bg-gray-600 px-3 py-2 rounded flex justify-between items-center"
                >
                  {selectedLanguage}
                  {dropdownOpen ? (
